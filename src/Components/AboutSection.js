...
function AboutSection() {
    return (
        <div className='aboutwrapper'>
            ...
            <p>I'm Peter Adelakun Ademurewa, a dedicated learner who transitioned into the tech industry
                with a background in Physiology. Through intensive self-study and hands-on practice,
                I've earned certifications in Responsive Web Design, JavaScript Algorithms and Data Structures,
